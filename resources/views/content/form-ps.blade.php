            ...
            <div class="col-md-12">
                <div class="row mx-auto justify-content-center">
                    <div class="col-md-9 text-center">
                        <p>We welcome regular partners and sponsors for events, campaigns and even for
                            books. The name of the sponsor will be included in all of our maketing materials
                ...
                <div class="row mx-auto justify-content-center">
                    <div class="col-md-6">
                        ...
                        <dl>
                            <dt>NOTE:</dt>
                            <dd>For interested sponsor you may contact : </dd>
                            <dd>tel. no. 6876649 loc. 109</dd>
                            <dd>cell no : 09435054641</dd>
                            <dd>email : amestoce@ilovemycountry.ph / jopahoyo@ilovemycountry.ph</dd>
                            <dd>Please deposite your sponsorship to:</dd>
                            <dd>I LOVE MY COUNTRY PH INC</dd>
                        </dl>
