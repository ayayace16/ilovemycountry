...
<div class="content-fluid">
    <nav class="navbar navbar-expand-lg navbar-light bg-white">
        <div class="navbar-brand" href="#">
            <img src="../image/cropped-logo.jpg" width="100" height="50" class="d-inline-block align-center" alt="ilovemycountry.ph">
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav justify-content-end">
                ...
                <li class="nav-item">
                    <div class="drowpdown">
                    <a href="#ilmcrun2019"  id="dropdownMenuLink" data-hover="dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">ILMC RUN 2019</a>
                ...
                <li class="nav-item">
                    <div class="drowpdown">
                    <a href="#sponsors" id="dropdownMenuLink" data-hover="dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">SPONSORS</a>
